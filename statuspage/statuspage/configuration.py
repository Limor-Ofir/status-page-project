...
CORS_ORIGIN_WHITELIST = [
    'https://statuspage.limor-status-page.online/',
    'statuspage.limor-status-page.online'
]
CORS_ORIGIN_REGEX_WHITELIST = [
    r'^(https?://)?(\w+.)?limor-status-page.online$',
]
...
CSRF_TRUSTED_ORIGINS = ['https://statuspage.limor-status-page.online/', 'https://*.limor-status-page.online/']
